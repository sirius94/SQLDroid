...
public class SQLDroidResultSet implements ResultSet {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SQLDroidResultSet.class);
  ...
  throws SQLException {
    LOGGER.warn(" ********************* not implemented correctly - Calendar is ignored. @ " + DebugPrinter.getFileName() + " line " + DebugPrinter.getLineNumber());
